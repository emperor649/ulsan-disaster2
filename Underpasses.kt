...
object Underpasses {
    ...
    val all: List<Underpass> = listOf(
        U(1, "우정지하차도", "종합건설본부", "중구", HIGH),
        U(2, "번영교강남지하차도", "종합건설본부", "남구", HIGH),
        U(3, "번영교강북지하차도", "종합건설본부", "중구", HIGH),
        U(4, "삼호지하차도", "종합건설본부", "남구", HIGH),
        U(5, "학성교강남지하차도", "종합건설본부", "남구", HIGH),
        U(6, "학성교강북지하차도", "종합건설본부", "중구", HIGH),
        U(7, "대안지하차도", "울주군 도로과", "울주군", HIGH),
        U(8, "명촌강북지하차도", "종합건설본부", "북구", LOW),
        U(9, "명촌산업지하차도", "종합건설본부", "북구", LOW),
        U(10, "명촌본선지하차도", "종합건설본부", "북구", HIGH),
        U(11, "옥현지하차도", "종합건설본부", "남구", LOW),
        U(12, "삼산지하차도", "종합건설본부", "남구", HIGH),
        U(13, "명촌교강남지하차도", "종합건설본부", "남구", HIGH),
        U(14, "상방지하차도", "종합건설본부", "북구", HIGH),
        U(15, "동천지하차도", "종합건설본부", "중구", HIGH),
        U(16, "병영성지하차도", "중구 건설과", "중구", LOW),
        U(17, "여천천지하차도", "남구 건설과", "남구", LOW),
        U(18, "화봉지하차도", "종합건설본부", "북구", HIGH),
        U(19, "중구청지하차도", "종합건설본부", "중구", LOW),
        U(20, "반천산단진입도로지하차도", "종합건설본부", "울주군", HIGH),
        U(21, "원유곡지하차도", "종합건설본부", "중구", LOW),
        U(22, "중산지구지하차도", "종합건설본부", "북구", LOW),
        U(23, "구남지하차도", "종합건설본부", "북구", LOW),
        U(24, "대송지하차도", "시 건설도로과 (울산하버브릿지)", "동구", LOW),
        U(25, "애전 개방형 BOX", "시 건설도로과 (울산하버브릿지)", "동구", LOW),
        U(26, "중산지하차도", "종합건설본부", "북구", LOW),
        U(27, "명정지하차도", "종합건설본부", "중구", HIGH),
        U(28, "신화지하차도 (교동지하차도)", "울주군 도로과", "울주군", HIGH),
        U(29, "산성지하차도", "울주군 도로과", "울주군", LOW),
        U(30, "울산역지하차도", "종합건설본부", "울주군", HIGH),
    )
